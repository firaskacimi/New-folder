...
const Register = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validate form
    const validationErrors = validateForm(formData, registerValidationRules);
  ...
  return (
    <div
      className="min-h-screen text-white flex items-center justify-center py-12"
      style={{
        background:
        ...
        <div className="bg-neutral-900/80 backdrop-blur-lg border border-gray-700 rounded-2xl p-8 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">
              Rejoignez-nous pour accéder aux meilleurs produits gaming
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 bg-neutral-800 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 transition-all duration-300"
            ...
            <div className="space-y-4">
              <label className="flex items-start">
                <input
                  ...
                  onChange={handleChange}
                  className="w-4 h-4 text-cyan-500 bg-neutral-800 border-gray-600 rounded focus:ring-cyan-500 focus:ring-2 mt-1"
                />
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-neutral-900 text-gray-400">Ou s'inscrire avec</span>
              </div>
            </div>
